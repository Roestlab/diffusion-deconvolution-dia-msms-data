# Contributing to diffusion-deconvolution-dia-msms

Thank you for your interest in contributing to `diffusion-deconvolution-dia-msms`! We welcome contributions of all kinds, including bug fixes, feature requests, documentation improvements, and code contributions. This guide will help you get started.
...
2. **Clone your fork**: Clone your forked repository to your local development environment.
    ...
    ```bash
    git clone https://github.com/diffusion-deconvolution-dia-msms/diffusion-deconvolution-dia-msms.git
    ```
...
By contributing to `diffusion-deconvolution-dia-msms`, you agree that your contributions will be licensed under the MIT License.

We appreciate your contributions and look forward to working together to improve `diffusion-deconvolution-dia-msms`!
